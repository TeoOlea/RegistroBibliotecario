	...
	<body>
		...
		<div class="clearfix">
			...
			<!-- De las opciones de los submit mandamos la opción a DefOpcionForm para elegir que hacer despues -->
				...
				<li>
					<dl>
						<dt><label for="matricula">Matricula, Código de Barras o No. de Control: </label></dt>
						...
						<dd><input type="text" id="matricula" name="matricula" class="input_matricula" autocomplete="off" required max=13 placeholder="Digita los datos" onKeyUp='ValidarExistencia( this, <?php echo json_encode( $arreglo_matricula ); ?>, <?php echo json_encode( $arreglo_codigobarra ); ?> )' ></dd>
						<dd id="text_comment" class="exito" hidden>El usuario está disponible</dd>
					</dl>
				</li>
				<li>
