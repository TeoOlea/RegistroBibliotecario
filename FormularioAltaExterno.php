		...
		<div class="clearfix">
			...
			<ul>
				...
				<br/>
					...
					<input type="submit" value="Dar de alta" id="evento_alta" name="evento_alta-externo" onclick="javascript:ValidarRequired();"/>
					<input type="submit" value="Cancelar" id="evento_cancelar" name="evento_cancelar-externo" onclick="javascript:NoValidarRequired();" />
				</form>
