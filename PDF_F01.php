<?php
	...
	require_once('plantillaTabla.php');
	
	$mpdf = new \Mpdf\Mpdf(['margin_left' => 8, 'margin_right' => 8, 'margin_top' => 37, 'margin_bottom' => 30,/*'setAutoTopMargin' => 'stretch', 'setAutoBottomMargin' => 'stretch',*/ 
	...
	//pdf->writeHtml("Hola Mundo", \Mpdf\HTMLParserMode::HTML_BODY);
	$mpdf->writeHtml($plantilla, \Mpdf\HTMLParserMode::HTML_BODY);

	//$mpdf->AddPage('L'); // Adds a new page in Landscape orientation
	//$mpdf->WriteHTML('Hello World');

	$mpdf->Output('FB-01 '.$mes_elegido.'.pdf', 'I');