...
<html>
	...
	<body>
		...
		<form action = "<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method = "post" >
			<center>
				<p>
					Fecha: <input type="text" id="fecha_mes" name="fecha_mes" readonly>
		...
		<div class="clearfixadmin">
			...
			if( isset($_POST['fecha_mes']) && $_POST['fecha_mes'] != "" ){ //Se define que la variable en el campo de texto sea "inicializada"
				...
				$sql_query = "SELECT * FROM visitas WHERE YEAR(FechaEntrada) = '$anyo' && MONTH(FechaEntrada) = '$numMes' ORDER BY time(FechaEntrada) ASC";
